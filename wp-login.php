...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/wp_local/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acceder">
									<input type="hidden" name="redirect_to" value="http://localhost/wp_local/wp-admin/">
...
/* <![CDATA[ */
var _zxcvbnSettings = {"src":"httplocalhost\/wp_local\/wp-includes\/js\/zxcvbn.min.js"};
/* ]]> */
</script>
...
/* <![CDATA[ */
var _wpUtilSettings = {"ajax":{"url":"\/wp_local\/wp-admin\/admin-ajax.php"}};
/* ]]> */
</script>
<script type="text/javascript" src="/wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"48f1208fee"};
/* ]]> */
</script>
